...
function orderFood(list: Array<{ firstName: string, lastName: string, country: string, continent: string, age: number, language: string, meal: string }>): Record<string, number> {
