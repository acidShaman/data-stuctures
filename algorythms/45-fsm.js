...
// Example usage:
console.log(traverseTCPStates(["APP_PASSIVE_OPEN", "APP_SEND", "RCV_SYN_ACK"])); // Output: "ESTABLISHED"
console.log(traverseTCPStates(["APP_ACTIVE_OPEN"])); // Output: "SYN_SENT"
console.log(traverseTCPStates(["APP_ACTIVE_OPEN", "RCV_SYN_ACK", "APP_CLOSE", "RCV_FIN_ACK", "RCV_ACK"])); // Output: "ERROR"
